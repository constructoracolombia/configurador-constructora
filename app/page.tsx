    ...
    <main className="min-h-screen bg-gradient-to-b from-brand-light via-white to-gray-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-primary via-brand-secondary to-brand-primary px-4 py-20 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl text-center animate-[fadeIn_0.5s_ease-in]">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 backdrop-blur-sm animate-[scaleIn_0.3s_ease-out]">
          ...
          <h1 className="mb-6 text-5xl font-bold leading-tight md:text-6xl">
            ...
            <span className="text-brand-accent">en 3 Minutos</span>
          </h1>
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  {"precioIntermedioEspecial" in proyecto &&
                    proyecto.precioIntermedioEspecial && (
                      <div className="absolute right-4 top-4 flex items-center gap-1 rounded-full bg-brand-primary px-3 py-1 text-xs font-bold text-brand-dark shadow-[0_4px_14px_0_rgba(245,166,35,0.39)]">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl bg-white p-6 text-center shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-all hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-primary to-brand-secondary shadow-[0_4px_14px_0_rgba(245,166,35,0.39)]">
              ...
              <p className="text-gray-600">
                +5 años remodelando apartamentos VIS en Bucaramanga
              </p>
            </div>
