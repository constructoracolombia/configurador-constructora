    ...
    <Card className="mt-8 overflow-hidden border-brand-border bg-brand-card">
      <CardContent className="p-6 md:p-8">
        ...
        <motion.div
          ...
          className="mb-6 flex flex-wrap items-center justify-between gap-4 rounded-lg border border-red-500/30 bg-gradient-to-r from-red-950/50 to-red-900/30 p-4"
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-white">Alta Demanda</span>
            <span className="text-brand-textSecondary">|</span>
            <span className="text-brand-textSecondary">Solo quedan 3 cupos este mes</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-2.5 w-28 overflow-hidden rounded-full bg-gray-700">
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: "80%" }}
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <motion.div
            ...
            className="flex flex-col items-center rounded-xl border border-brand-border bg-brand-dark p-5 text-center"
          >
            <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-brand-primary/20">
              <Shield className="h-7 w-7 text-brand-primary" />
            </div>
            <h4 className="font-semibold text-brand-text">Precio Congelado</h4>
          ...
          >
            ...
            <h4 className="font-semibold text-brand-text">Fecha Garantizada</h4>
            <p className="mt-1 text-xs text-brand-textSecondary">
          ...
          <motion.div
            ...
            className="flex flex-col items-center rounded-xl border border-brand-border bg-brand-dark p-5 text-center"
          >
            <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-green-500/20">
              <CheckCircle className="h-7 w-7 text-green-500" />
            </div>
            <h4 className="font-semibold text-brand-text">100% Modificable</h4>
            <p className="mt-1 text-xs text-brand-textSecondary">
        ...
        <div className="space-y-4">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              className="flex h-auto w-full items-center justify-center gap-3 rounded-xl bg-green-600 px-6 py-5 text-lg font-bold text-white shadow-lg shadow-green-600/30 transition-all hover:bg-green-500 hover:shadow-xl hover:shadow-green-500/40 disabled:opacity-70"
            >
        ...
        {/* Info adicional */}
        <div className="mt-6 rounded-lg bg-blue-950/30 p-4">
          <p className="mb-3 flex items-center gap-2 text-sm text-brand-textSecondary">
            <MessageSquare className="h-4 w-4 text-blue-400" />
            ¿No estás seguro? Agenda una reunión gratuita de 30 min
          </p>
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-blue-400">
