      ...
      <Card className="relative mt-8 overflow-hidden border-2 border-brand-primary bg-gradient-to-br from-brand-card via-black to-brand-card shadow-[0_10px_40px_0_rgba(255,184,0,0.4)]">
        ...
        <CardContent className="relative space-y-6 p-8">
          ...
          <div className="pt-4">
            ...
            {/* Texto explicativo */}
            <div className="mb-4 rounded-lg border-l-4 border-blue-500 bg-blue-900/20 p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs leading-relaxed text-brand-textSecondary">
                    Agenda una reunión virtual gratuita de 30 minutos con
                    nuestros profesionales. Aclaramos todas tus dudas, revisamos
                    acabados y confirmamos los detalles de tu proyecto.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <svg
                className="mr-3 h-6 w-6 text-blue-400 transition-transform group-hover:scale-110"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              Agendar Reunión Virtual Gratis
            </Button>

            <p className="mt-3 text-center text-xs text-brand-textSecondary">
              📅 Resuelve todas tus dudas con un profesional • 🎥 Reunión virtual
              de 30 min
            </p>
          </div>
        </CardContent>
